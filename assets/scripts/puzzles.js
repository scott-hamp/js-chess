...
{
    var index = Math.floor((Math.random() * _puzzles.length) + 1) - 1;
...
{
    var lines = _puzzlesRawData.split("\n");
    ...
    for(var i = 0; i < lines.length; i++)
    {
        ...
        if(line.length == 0)
        {
            if(localLines.length > 0)
            {
                ...
                if(puzzle.instructions.length == 0)
                {
                    var value = "White to move.";
                    if(puzzle.FEN.split(" ")[1] == "b")
                        value = "Black to move."

                    puzzle.instructions = value;
                }
